...
class ProfileScreenOrganizer extends StatelessWidget {
  const ProfileScreenOrganizer({Key key}) : super(key: key);
    ...
    return  BlocProvider(
          ...
          child: BlocConsumer<HomeCubit, HomeStates>(
            listener: (context, state) {
              if(state is GetLoadingProfileDataHomeStates){
                print("loading");
              }
            },
            builder: (context, state) {
              ...
              return
                Scaffold(
                    ...
                    body: state is  GetLoadingProfileDataHomeStates?
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Column(
                                    children: [
                                      Text(
                                        cubit.profileList[0].fname + " " +
                                            cubit.profileList[0].lname,
                                ...
                                child: Row(
                                  children: [
                                    Expanded(
                                      child: Row(
                                        children: [
                                          Text(getLang(context, "Edit Profile"),
                                            style: const TextStyle(
                                              color: Colors.black,
                                              fontSize: 12,),),
                                          const Spacer(),
                          ...
                          child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Icon(Icons.support_agent,
                                      color: Colors.deepOrange[400],),
                                    SizedBox(width: 10,),
                                    Text(getLang(context, "the support"),
                                      style: const TextStyle(
                                          color: Colors.black,
                                          fontSize: 14,
                                          fontWeight: FontWeight.bold),),
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    Text(getLang(context, "who are we"),
                                      style: const TextStyle(
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    Text(getLang(context, "Privacy Policies"),
                                      style: const TextStyle(
                                        color: Colors.black,
                                        fontSize: 14,),),
                                    const Spacer(),
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    Text(getLang(context, "Connect with us"),
                                      style: const TextStyle(
                                        color: Colors.black, fontSize: 14,),),
                                    const Spacer(),
                                    const Icon(Icons.chevron_right_rounded,
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      getLang(context, "Terms and Conditions"),
                                      style: const TextStyle(
                                        color: Colors.black, fontSize: 14,),),
                                    const Spacer(),
                                    const Icon(Icons.chevron_right_rounded,
                            ...
                            DropdownButton(
                              ...
                              hint: Padding(
                                padding: const EdgeInsets.only(
                                    right: 22.0, left: 22),
                                child: Text(getLang(context, "Language"),
                            ...
                            state is LogOutLoadingStates ? const Center(
