...
class EditEventSponsor extends StatelessWidget {
  int id;
  EditEventSponsor({Key key,this.id}) : super(key: key);
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            const CircularProgressIndicator(): MaterialButton(
                                      ...
                                      if(valueOfLocation!=null|| OrganizerCubit
                                        ...
                                        if (OrganizerCubit
                                          ...
                                          OrganizerCubit.get(context)
                                              ...
                                              _controllersListOfAvailableSeats,id
                                          );
                                        } else {
                              ...
                              child:  Text(getLang(context, "Edit"), style: const TextStyle(
                                  color: Colors.white),),
                            ),
                          ],
                        ),
