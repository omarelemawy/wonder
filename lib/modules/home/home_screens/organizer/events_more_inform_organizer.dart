...
class EventMoreInformOrganizer extends StatelessWidget {
  int id;

  EventMoreInformOrganizer(this.id, {Key key}) : super(key: key);
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Container(
                            ...
                            child: MaterialButton(
                              ...
                              child: Text(getLang(context, "Date"), style: const TextStyle(color:
                              Colors.white,
                                  fontSize: 13,
                                  fontWeight: FontWeight.bold),),
                            ),
                          ...
                          Container(
                            ...
                            child: MaterialButton(
                              ...
                              child: Text(getLang(context, "sponsors"), style: const TextStyle(color:
                              Colors.white,
                                  fontSize: 13,
                                  fontWeight: FontWeight.bold),),
                            ),
                          ...
                          Container(
                            ...
                            child: MaterialButton(
                              ...
                              child: Text(getLang(context, "owner"), style: const TextStyle(color:
                              Colors.white,
                                  fontSize: 13,
                                  fontWeight: FontWeight.bold),),
                            ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: (){
                                MapUtils.openMap(30.722636, 31.036705);
                              },
                              child: Text(
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            const Text("SR", style: const TextStyle(color: Colors.black,
                                fontWeight: FontWeight.bold,
                                fontSize: 25),),
                            const SizedBox(width: 5,),
                      ...
                      Center(child: Text(getLang(context, "Comments"), style: const TextStyle(
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  Row(
                                    children: [
                                      Text(getLang(context, "start in"), style: const TextStyle(
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  Row(
                                    children: [
                                      Text(getLang(context, "Expires in"), style: const TextStyle(
                                          color: Colors.black, fontSize: 16),),
                                      const Text( " : ",
                                        style: TextStyle(color: Colors.black,
                                            fontSize: 16),),
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  Row(
                                    children: [
                                      Text(getLang(context, "availableSeats"), style: const TextStyle(
                                          color: Colors.black, fontSize: 16),),
                                      const Text( ":",
                                        style: TextStyle(color: Colors.black,
                                            fontSize: 16),),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Row(
                          children: [
                            Text(getLang(context, "Email"), style: const TextStyle(
                                color: Colors.black, fontSize: 16),),
                            const Text( " : ",
                              style: TextStyle(color: Colors.black,
                                  fontSize: 16),),
                        ...
                        const SizedBox(width: 10,),
                        Expanded(
                          child: Text("${owner.email}", style: const TextStyle(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Row(
                          children: [
                            Text(getLang(context, "Phone"), style: const TextStyle(
                                color: Colors.black, fontSize: 16),),
                            const Text( " : ",
                              style: TextStyle(color: Colors.black,
                                  fontSize: 16),),
                        ...
                        const SizedBox(width: 10,),
                        Expanded(
                          child: Text("${owner.phone} ", style: const TextStyle(
                              color: Colors.deepOrangeAccent, fontSize: 16),
                              overflow: TextOverflow.ellipsis,
                              maxLines: 2),
                        ),
